...
const Time = ({ cycel }) => {
    ...
    return (
        <>
            <span className='grid grid-cols-3 mt-3 gap-20 uppercase text-4xl items-center'>
                {dataArr[0]}
                {/* <span className='flex justify-center'>
                    <img src='./src/assets/aero.png' className='h-[90px]' />
                </span> */}
                <div className='flex flex-col justify-center items-center h-full text-5xl pb-6 gap-1'>
                    <h1>{date}</h1>
                    <span className='flex justify-center'>
