const RowTableHeader = ({ cycel }) => {
    return (
        <div className="w-1/2 mr-10 last:mr-0 text-2xl">
            <ul className="grid grid-cols-5 mt-3">
                ...
                <li className="flex items-center justify-center pl-20">{cycel === 0 ? "Рейс" : "Flight"}</li>
                <li className="flex items-center justify-end">{cycel === 0 ? "Авиакомпания" : "Company"}</li>
            </ul>
